...
const ProfileCard = () => {
  return (
    <div className="bg-white drop-shadow-sm rounded-lg border-2 border-solid border-slate-100 relative min-h-48 max-w-64 lg:max-w-full">
      <div className="h-11 bg-gradient-to-r from-metaversal-light-purple to-metaversal-light-peach rounded-t-lg"></div>
      ...
      <div className="p-2.5 w-full border-solid border-slate-100 border-t-2 bg-gradient-to-b from-white to-slate-50 rounded-b text-center lg:text-left">
